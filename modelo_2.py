...
model.add(Conv2D(kernel_size=3, strides=2, filters=32, padding="same", activation="relu", name="capa_2"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=3, strides=2, filters=32, padding="same", activation="relu", name="capa_3"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=3, strides=1, filters=32, padding="same", activation="elu", name="capa_4"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=5, strides=1, filters=32, padding="same", activation="sigmoid", name="capa_5"))
model.add(MaxPool2D(pool_size=2, strides=2))
...
#entrenamiento
model.fit(x=imagenes, y=probabilidades, epochs=18,batch_size=30)
