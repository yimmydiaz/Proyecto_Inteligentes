...
model.add(Conv2D(kernel_size=5, strides=2, filters=64, padding="same", activation="relu", name="capa_1"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=3, strides=1, filters=36, padding="same", activation="relu", name="capa_2"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=5, strides=2, filters=64, padding="same", activation="sigmoid", name="capa_3"))
model.add(MaxPool2D(pool_size=2, strides=2))

model.add(Conv2D(kernel_size=3, strides=1, filters=64, padding="same", activation="sigmoid", name="capa_4"))
model.add(MaxPool2D(pool_size=2, strides=2))
